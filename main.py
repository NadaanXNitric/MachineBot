...
MONGO_URL = os.environ.get("MONGO_URL", "mongodb+srv://LyraChatbot:LyraChatbot@cluster0.xfccb2x.mongodb.net/?retryWrites=true&w=majority")
...
print("Your Chatbot Is Ready Now! Join @TheXCodeTeam")
bot.run()
